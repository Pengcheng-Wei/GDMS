...
<%
String j_auth_action=request.getContextPath()+"/doc_reviewRepForLeadIndex.action";
%>
	...
	<div class="container">
		...
		<table class="table table-hover table-bordered">
		  ...
		  <tbody>
			   ...
			   <c:forEach items="${pageBeanReAu.data}" var="reviewAudit" varStatus="varSta">
					...
					<c:choose>
			    	 	 	<c:when test="${reviewAudit.l_opt != null and reviewAudit.l_opt!=''}">
	 ...
	 <script type="text/javascript">
  	...
  	function changePageSize(){
  		...
  		var url = "<%=j_auth_action%>"+"?currentPage=1&pageSize="+pageSize;
  	...
  	function changePage(){
  		...
  		var url = "<%=j_auth_action%>?currentPage="+curPage+"&pageSize=${pageBeanReAu.pageSize}";
  		window.location.href=url;
  	}
  </script>
</body>
