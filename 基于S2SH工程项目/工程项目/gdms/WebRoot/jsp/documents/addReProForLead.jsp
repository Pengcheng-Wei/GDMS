...
<%
String j_auth_action=request.getContextPath()+"/doc_updateReProForLead.action";
%>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
  ...
  <body>
	...
	<div class="ue-container">
		...
		<input name="reaserchProposal.t_time" id="t_time" style="display: none" value="${reaserchProposal.t_time }"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control ue-form" id="deadline"
						name="reaserchProposal.deadline" value="${reaserchProposal.deadline}"  placeholder="格式：yyyy/mm/dd，如：2017/08/01" readonly="readonly"/>
				</div>
				<label class="col-sm-2 control-label">计划撰写字数：</label>
				<div class="col-sm-3">
					<input type="text" class="form-control ue-form" id="totalSum"
						name="reaserchProposal.totalSum" value="${reaserchProposal.totalSum}" placeholder="（数字）千字" readonly="readonly"/> 
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control ue-form" 
						name="reaserchProposal.dept_name" value="${leader.name}" />
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="reaserchProposal.sub_gogal" class="form-control ue-form" rows="5" id="sub_gogal" readonly="readonly">${reaserchProposal.sub_gogal }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">本选题国内外研究现状：</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.sub_background" class="form-control ue-form" rows="5" id="sub_background" readonly="readonly">${reaserchProposal.sub_background }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">本选题的主要研究内容（提纲）：</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.sub_content" class="form-control ue-form" rows="5"  id="sub_content" readonly="readonly">${reaserchProposal.sub_content }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">围绕本选题已做哪些准备工作，计划再做的工作：</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.sub_plan" class="form-control ue-form" rows="5" id="sub_plan" readonly="readonly">${reaserchProposal.sub_plan }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">拟解决的关键问题：</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.sub_question" class="form-control ue-form" rows="5" id="sub_question" readonly="readonly">${reaserchProposal.sub_question }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">主要参考文献（不少于10篇）：</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.sub_refe" class="form-control ue-form" rows="5" id="sub_refe" readonly="readonly">${reaserchProposal.sub_refe }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">指导教师意见：</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.t_opt" class="form-control ue-form" rows="5" id="t_opt" readonly="readonly">${reaserchProposal.t_opt }</textarea>	
				</div>			
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">学院意见:</label>
				<div class="col-sm-9">
					<textarea name="reaserchProposal.dept_opt" class="form-control ue-form" rows="5" id="dept_opt">${reaserchProposal.dept_opt }</textarea>	
				</div>			
			</div>
