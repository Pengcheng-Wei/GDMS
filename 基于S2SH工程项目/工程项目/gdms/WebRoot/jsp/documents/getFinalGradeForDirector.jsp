...
<%
String j_auth_action=request.getContextPath()+"/doc_getFinalGradeForDire.action";
%>
	...
	<div class="container">
	 ...
	 <script type="text/javascript">
  	...
  	function changePageSize(){
  		...
  		var url = "${pageContext.request.contextPath}/doc_getFinalGradeForDire.action?currentPage=1&pageSize="+pageSize;
  	...
  	function changePage(){
  		...
  		var url = "${pageContext.request.contextPath}/doc_getFinalGradeForDire.action?currentPage="+curPage+"&pageSize=${pageBeanStudent.pageSize}";
  		window.location.href=url;
  	}
  </script>
</body>
