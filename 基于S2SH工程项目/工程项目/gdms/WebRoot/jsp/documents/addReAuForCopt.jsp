...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="ue-container">
		...
		<input name="reviewAudit.c_name" style="display: none" value="${teacher.name}"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control ue-form" 
						name="reviewAudit.c_time" id="c_time" value="${reviewAudit.c_time}"  readonly="readonly"/>
				</div>
				...
				<div class="col-sm-2">
					<input type="text" class="form-control ue-form" 
						id="c_grade" name="reviewAudit.c_grade" value="${reviewAudit.c_grade}" placeholder="百分制"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="reviewAudit.c_opt" class="form-control ue-form" rows="5" id="c_opt" >${reviewAudit.c_opt }</textarea>	
				</div>			
			</div>
