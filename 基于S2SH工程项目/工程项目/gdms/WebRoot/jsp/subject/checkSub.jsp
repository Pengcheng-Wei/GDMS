		...
		<div style="display: none">
					<div class="col-sm-9">
						<input type="text" class="form-control ue-form" 
							name="subject.sub_id" value="${subject.sub_id }" placeholder="名称"  readonly="true"/>			
					</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control ue-form" id="subName"
						name="subject.subName" value="${subject.subName }" placeholder="名称" />			
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control ue-form" id="en_name"
						name="subject.en_name" value="${subject.en_name }" placeholder="英文名称" />			
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control ue-form" id="tech"
						name="subject.tech" value="${subject.tech }" placeholder="所需技术"/>			
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">项目简述</label>
				<div class="col-sm-9">
					<textarea id="order" name="subject.intro" class="form-control ue-form" rows="5" placeholder="简介不得少于200字">${subject.intro }</textarea>	
				</div>			
			</div>
			<div class="form-group" >
