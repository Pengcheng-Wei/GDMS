...
<%
String j_auth_action=request.getContextPath()+"/sub_getAll.action";
%>
		  ...
		  <tbody>
			   ...
			   <c:forEach items="${pageBean.data}" var="subject" varStatus="varSta">
					...
					<c:choose>
			    	 	...
			    	 	<td><a href="${pageContext.request.contextPath}/sub_seeSub.action?sub_id=${subject.sub_id}">去审核</a></td>
			    	 </tr>
	    		  </c:forEach>
	    	<tr>
